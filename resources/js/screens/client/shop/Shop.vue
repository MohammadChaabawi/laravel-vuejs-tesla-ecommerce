                ...
                <v-card>
                    ...
                    >
                        ...
                        <div class="text-center">
                            <v-btn @click="() => navigateToCategoryScreen(category)" class="white--text" outlined
                                >View Products</v-btn
                            >
                        </div>
                    </v-img>
                            ...
                            <div class="col-md-2 col-sm-4 col-xs-12 text-center" v-for="product in products" :key="product.id">
                                <v-hover v-slot:default="{ hover }" open-delay="240">
                                    <v-card :elevation="hover ? 16 : 2">
                                        ...
                                        <div class="text-center">
                                            <v-btn class="ma-2" @click="() => $router.push({name: 'ProductDetails', query: { product }})" outlined color="info">View Product</v-btn>
                                        </div>
                                    </v-card>
                                </v-hover>
                            </div>
